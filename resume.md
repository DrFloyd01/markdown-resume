...
#### Mechanical Engineer with 2+ years of professional experience developing healthcare technology. Demonstrates a passion for finding solutions that improve patient care and quality of life. Seeking opportunities to leverage can-do attitude in developing cutting-edge medical technologies that address critical healthcare challenges. 
...
- **Accelerated Life Testing:** Scripted CMM programs to quantify gear profiles. Designed fixture for thermal
chamber testing.
...
prosthesis.
- **Work Instructions:** Developed IMU-based system calibration protocol. Iterated embedded hardware validation
using oscilloscope and software tests.
- **Embedded Systems:** Implemented in-house API and SDK libraries in C to control PWM motors. Completed a
feature branch pull request and merge while practicing Git commit best practices

Skills
------
**Lab Tools:** Strain Gauges, Encoders, IMUs; Mitutoyo CMM, SLA/FDM 3D Printers, Wet Lab PPE

**Software:** SolidWorks PDM (CSWP), MATLAB, Arduino, LabVIEW, Unity, git
...
Notes
--------
**Programming:** Python, MATLAB, Arduino, SEGGER Embedded Studio, git, AutoCAD, ANSYS Workbench, 
